...
const DetailLaporan = () => {
  ...
  const ProgressBarWithDots = ({ status }) => {
    ...
    const steps = [
      { label: "Dilaporkan", step: 1 },
      { label: "Tervalidasi", step: 2 },
      { label: "Ditangani", step: 3 },
      ...
      <div className="max-w-lg mx-auto">
        ...
        <div className="bg-white rounded-xl shadow-lg overflow-hidden mb-6">
          ...
          <div className="p-6">
            ...
            {/* Progress Bar Status dengan Dot */}
            <div className="border-t pt-6 mt-6">
              <ProgressBarWithDots status={laporanDetail.status || "PENDING"} />
            </div>
          </div>
        </div>
